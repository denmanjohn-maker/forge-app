...
This project is indexed by GitNexus as **forge-app** (3382 symbols, 6704 relationships, 168 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
